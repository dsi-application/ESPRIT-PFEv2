...
export default class FicheDepotPFE extends Component {
  constructor(props) {
    ...
    // init3
    this.loadStudentsAffectedToPC = this.loadStudentsAffectedToPC.bind(this);
  ...
  // init5
    ...
    downloadGrilleAE(studentId) {
        axios.get(`${process.env.REACT_APP_API_URL_AE}` + "downloadGrilleAE/" + studentId, { responseType: "blob" })
            .then((response) => {
    ...
    loadStudentsAffectedToPC()
    {
        PCService.studentsTrainedByPCE(currentPedagogicalCoordinator.id).then(
        (response) => {
      ...
      return (
          <>
                        ...
                        <CRow>
                            <CCol md="10" class="bg-success py-2">
                              <span style={{color: "#cc0000", fontSize: "14px", fontWeight: "bold"}}>
                                Liste des Étudiants Affectés - ({listOfAuthorizedStudentsToSTNByFilter.length}/{listOfStudentsTrainedByPE.length})
                              </span>
                            </CCol>
                        </CRow>
                      </CContainer>
            ...
            <Dialog fullHight fullWidth
                ...
                <DialogContent>
                  <center>
                    Vous avez traité le Dépôt Plan Travail de l'étudiant &nbsp;
              ...
              <Dialog fullHight fullWidth
                ...
                <DialogContent>
                  <center>
                    Vous avez validé le Dépôt Plan Travail de l'étudiant &nbsp;
                    <span className="text-primary" style={{fontSize: "12px"}}>
                      {selectedStudentFullName}
                    </span>
                  </center>
