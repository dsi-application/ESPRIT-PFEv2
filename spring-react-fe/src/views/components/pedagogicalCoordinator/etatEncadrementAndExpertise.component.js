...
export default class etatEncadrementAndExpertise extends Component {
  constructor(props) {
    super(props);
  ...
  loadAcademicEncadrants()
  {
    ...
    PedagogicalCoordinatorService.findAllAcademicEncadrantsAndExpertsByYear(this.state.selectedYear).then(
        (response) => {
  ...
  handleDownloadEncadrementStatus()
  {
    ...
    ResponsableServiceStageService.downloadAllEncadrementAndExpertiseStatusByYear(this.state.selectedYear).then(
        (response) => {
  ...
  */
    ...
    PedagogicalCoordinatorService.findAllAcademicEncadrantsAndExpertsByYear(selectedCompOption.label).then(
        (response) => {
          this.setState({
            academicEncadrants: []
          });
                ...
                <CCol md="1">
                  {
                    ...
                    <CButton shape="pill"
                      ...
                      <CTooltip content="Télécharger l'État Encadrements / Expertises"
                                placement="top">
