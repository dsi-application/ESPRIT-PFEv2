...
export default class StudentsForExpertise extends Component {
    constructor(props) {
        super(props);
    ...
    loadStudentsAffectedToExpertByDefaultYear() {
        AcademicEncadrantService.studentsForExpertiseByExpertAndYear(currentTeacher.id, this.state.selectedYear).then(
            (response) => {
    ...
    loadStudentsAffectedToExpert = (selectedYearObject) => {
        ...
        AcademicEncadrantService.studentsForExpertiseByExpertAndYear(currentTeacher.id, selectedYearObject.label).then(
            (response) => {
                                                                    ...
                                                                    action: (item) => (
                                                                        <td>
                                                                            ...
                                                                            <center>
                                                                                ...
                                                                                {
                                                                                    item.studentMarkRest === null &&
                                                                                    <CButton shape="pill"
                                                                                             color="dark"
                                                                                             size="sm"
                                                                                             aria-expanded="true"
                                                                                             onClick={() => this.handleGiveMarkToStudent(item.studentId, item.studentFullName, item.studentMarkRest)}>

                                                                                        <CTooltip
                                                                                            content="Saisir Note Restitution"
                                                                                            placement="top">
                                                                                ...
                                                                                {
                                                                                    item.studentMarkRest !== null && item.letChangeNoteRestitution === 'YES' &&
                                                                                    <CButton shape="pill"
                                                                                             color="secondary"
                                                                                             size="sm"
                                                                                             aria-expanded="true"
                                                                                             onClick={() => this.handleModifyMarkOfStudent(item.studentId, item.studentFullName, item.studentMarkRest)}>
                                                                                ...
                                                                                {
                                                                                    item.letChangeNoteRestitution === 'NO' &&
                                                                                    <CButton shape="pill"
                                                                                             color="success"
                                                                                             size="sm"
                                                                                             aria-expanded="true">

                                                                                        <CTooltip content="Le Changement de la Note n'est plus possible : La Grille Encadrement de cet Étudiant est validée par son Encadrant Académique." placement="top">
                                                                                            <CIcon content={freeSet.cilCheckAlt}/>
                                                                                        </CTooltip>
                                                                                    </CButton>
                                                                                }
