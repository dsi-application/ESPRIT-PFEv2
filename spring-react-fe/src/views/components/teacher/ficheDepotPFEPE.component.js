...
export default class FicheDepotPFE extends Component {
    ...
    downloadGrilleAE(e) {
        axios.get(`${process.env.REACT_APP_API_URL_AE}` + "downloadGrilleAE/" + this.state.selectedStudentId, { responseType: "blob" })
            .then((response) => {
    ...
    handleTreatDepotPFE(idEt, fullName, classe, dateDepot) {
        ...
        requestPE.open("GET", API_URL_AE + "studentGrilleEncadrement/" + idEt, false);
        requestPE.send(null);
        let pe = JSON.parse(requestPE.responseText);

        // console.log("----------------------Object", pe)
                                                                                ...
                                                                                <center>
                                                                                    <TextField id="marka"
                                                                                               ...
                                                                                               onChange={(e) => {
                                                                                                   ...
                                                                                                   this.state.noteGEA1 = Number(e.target.value) + Number(this.state.noteGEAz) + Number(this.state.noteGEAe) + Number(this.state.noteGEAr) + Number(this.state.noteGEAt) + Number(this.state.noteGEAy) + Number(this.state.noteGEAu) + Number(this.state.noteGEAi) + Number(this.state.noteGEAo);
