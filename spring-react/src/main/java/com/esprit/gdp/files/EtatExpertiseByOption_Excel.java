...
public class EtatExpertiseByOption_Excel
{
    ...
    public EtatExpertiseByOption_Excel(List<ExpertiseStatusExcelDto> ess, String optionlabel, String PSFile)
	{
		try
		{
			HSSFWorkbook workbook = new HSSFWorkbook();
			HSSFSheet sheet = workbook.createSheet("Année Universitaire 2021-2022");
